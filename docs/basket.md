...
* `bool exist(int mask)` — проверить наличие хотя бы одного флага из указанных в маске.
* `bool empty(int mask)` — проверить отсутствие строго всех флагов указанных в маске.
* `bool every(int mask)` — проверить наличие строго всех флагов указанных в маске.
